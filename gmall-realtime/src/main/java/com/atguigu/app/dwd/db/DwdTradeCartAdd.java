...
public class DwdTradeCartAdd {
    public static void main(String[] args) {
        ...
        tableEnv.executeSql(MyKafkaUtil.getTopicDb("topic_db","car_add"));
        ...
        tableEnv.executeSql("" +
                ...
                "    `source_name` STRING, " +
                "    `source_id` STRING " +
                ") " + MyKafkaUtil.getSinkKafkaDDL("dwd_trade_cart_add"));
