 ...
 */
public class DwdTradeOrderPreProcessDemo {
    public static void main(String[] args) throws Exception {
        ...
        //TODO 2.从kafka的 topic_db主题 读取数据创建流 并提取处理时间
        tableEnv.executeSql(MyKafkaUtil.getTopicDb("topic_db","dwd_trade_order_pre_process"));
        ...
        //TODO 7.构建MySQL中的 base_dic LookUp表
        ...
        //打印测试 因为此表涉及leftjoin 不能使用追加流
        tableEnv.toChangelogStream(resultTable).print("resultTable>>>>>>>>>");


        //TODO 9.构建Kafka Upsert表 dwd_trade_order_pre_process
        tableEnv.executeSql("" +
        ...
        //TODO 11.启动任务 用于打印流结果
        env.execute("DwdTradeOrderPreProcessDemo");
    }
}
