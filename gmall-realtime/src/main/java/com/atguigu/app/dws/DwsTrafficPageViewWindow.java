...
public class DwsTrafficPageViewWindow {
    ...
    public static void main(String[] args) throws Exception {
      ...
      /*   1.1 状态后端设置
        ...
        //TODO 2.读取Kafka dwd_traffic_page_log主题主题数据创建流
        DataStreamSource<String> kafkaDS = env.addSource(MyKafkaUtil.getFlinkKafkaConsumer("dwd_traffic_page_log", "dws_traffic_page_view_window","hadoop102:9092"));
