...
public class DwsTrafficVcChArIsNewPageViewWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //TODO 2.读取Kafka DWD层3个主题的数据创建流(页面日志、跳出明细和独立访客）
        DataStreamSource<String> pageLogDS = env.addSource(MyKafkaUtil.getFlinkKafkaConsumer("dwd_traffic_page_log", "page_view","hadoop102:9092"));
        DataStreamSource<String> uvLogDS = env.addSource(MyKafkaUtil.getFlinkKafkaConsumer("dwd_traffic_unique_visitor_detail", "page_view","hadoop102:9092"));
        DataStreamSource<String> ujLogDS = env.addSource(MyKafkaUtil.getFlinkKafkaConsumer("dwd_traffic_user_jump_detail", "page_view","hadoop102:9092"));
